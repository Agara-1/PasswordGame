...
export const CountryFlagValidator: React.FC<Props> = ({ password }) => {
    ...
    return (
        <div className={`alert ${isValid ? 'alert-success' : 'alert-warning'} mt-3 d-flex align-items-center justify-content-between theme-info-box border`}>
            <div className="text-start">
                <strong>Úkol s vlajkou:</strong><br/>
